...
{
    public static class MultiSubTitleEFCoreExtensions
    {
        public static EntityTypeBuilder<TEntity> OwnsOneMultiSubTitle<TEntity>(this EntityTypeBuilder<TEntity> entityTypeBuilder,
            Expression<Func<TEntity, MultiSubTitle>> navigationExpression, bool required = true, int maxLength = 200) where TEntity : class
        {
            /*
